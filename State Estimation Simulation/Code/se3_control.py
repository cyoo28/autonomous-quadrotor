...
class SE3Control(object):
    def __init__(self, quad_params):
        ...
        # define any additional constants you like including control gains.
        ...
        """
        # Geometric Control
        self.k_p = 12#*np.eye(3) #8.3
        self.k_d = 4.5#*np.eye(3) #4.45
        self.k_R = 300#*np.eye(3) #1000
        self.k_w = 30#*np.eye(3) #100
